...
class Device {
  ...
  String hostname, ip_addr, last_interaction, mac_addr, mud_url, vendor_class, room;
  int id;
  MUDData mud_data;

  Device(this.hostname, this.ip_addr, this.last_interaction, this.mac_addr,
      this.mud_url, this.vendor_class, this.room, this.id, this.mud_data);
